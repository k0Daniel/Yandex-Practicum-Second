...
randomBtn.onclick = function () {
	...
	const randomAgility = document.getElementById('agility');
	const additionalStat = document.getElementById('additionalStat');
	randomLvl.value = Math.round(Math.random() * 10);
	randomStrength.value = random();
	randomIntelligence.value = random();
	randomAgility.value = random();
	additionalStat.value = random();
